...
card:select - выбор карточки для ее открытия \
...
contacts:submit - отправка в форме ввода контактных данных \
formErrors:change - валидация форм \
basket:change - изменение данных корзины \